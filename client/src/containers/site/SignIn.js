...
class SignIn extends React.Component {
    ...
    handleSubmit () {
        ...
        // 发送请求
        this.props.dispatch(actionCreator.fetchSignIn(username, password))
            .then((result)=>{
                ...
                if(result.status){
                    Toast.success(result.message, ()=>{
                        // 跳到首页
                        // store存储个人信息
                        this.props.dispatch(actionCreator.updatePersonalInfo({username}));
...
export default connect(mapStateToProps,dispatch=> {return { ...bindActionCreators(actionCreator, dispatch), dispatch }})(SignIn)